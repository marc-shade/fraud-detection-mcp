...
**Date**: 2026-05-04T08:46:35.107903
**Sample size**: 300
**Random seed**: 42
**Optimal F1 operating threshold**: `0.45`
**Best F1**: `0.8273` (precision=0.8984, recall=0.7667)
...
| 0.35 | 0.514 | 1.000 | 0.679 | 150 | 142 | 8 | 0 |
| 0.40 | 0.672 | 0.847 | 0.749 | 127 | 62 | 88 | 23 |
| 0.45 | 0.898 | 0.767 | 0.827 | 115 | 13 | 137 | 35 |
| 0.50 | 1.000 | 0.520 | 0.684 | 78 | 0 | 150 | 72 |
...
|---|---|---|---|---|---|---|
| no_signature_claimed | 36 | 4 | 0.111 | 0.409 | 0.384 | 0.475 |
| novel_merchant_location | 31 | 31 | 1.000 | 0.540 | 0.527 | 0.577 |
| high_amount_unusual_hour | 26 | 26 | 1.000 | 0.586 | 0.551 | 0.627 |
| tampered_signature | 42 | 42 | 1.000 | 0.489 | 0.459 | 0.529 |
| forged_key | 15 | 12 | 0.800 | 0.477 | 0.447 | 0.523 |
