...
**Date**: 2026-05-04T07:40:42.016082
**Sample size**: 300
**Random seed**: 42
**Optimal F1 operating threshold**: `0.45`
**Best F1**: `0.8214` (precision=0.8846, recall=0.7667)
...
| 0.40 | 0.660 | 0.867 | 0.749 | 130 | 67 | 83 | 20 |
| 0.45 | 0.885 | 0.767 | 0.821 | 115 | 15 | 135 | 35 |
...
|---|---|---|---|---|---|---|
| no_signature_claimed | 36 | 3 | 0.083 | 0.409 | 0.380 | 0.477 |
| novel_merchant_location | 31 | 31 | 1.000 | 0.540 | 0.527 | 0.577 |
| high_amount_unusual_hour | 26 | 26 | 1.000 | 0.586 | 0.551 | 0.627 |
| tampered_signature | 42 | 42 | 1.000 | 0.489 | 0.458 | 0.528 |
| forged_key | 15 | 13 | 0.867 | 0.479 | 0.445 | 0.519 |
