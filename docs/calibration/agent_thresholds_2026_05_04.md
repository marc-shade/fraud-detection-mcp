...
**Date**: 2026-05-04T07:59:38.390566
**Sample size**: 300
**Random seed**: 42
**Optimal F1 operating threshold**: `0.45`
**Best F1**: `0.8614` (precision=0.9829, recall=0.7667)
...
| 0.35 | 0.573 | 1.000 | 0.728 | 150 | 112 | 38 | 0 |
| 0.40 | 0.815 | 0.880 | 0.846 | 132 | 30 | 120 | 18 |
| 0.45 | 0.983 | 0.767 | 0.861 | 115 | 2 | 148 | 35 |
| 0.50 | 1.000 | 0.527 | 0.690 | 79 | 0 | 150 | 71 |
...
|---|---|---|---|---|---|---|
| no_signature_claimed | 36 | 4 | 0.111 | 0.408 | 0.370 | 0.482 |
| novel_merchant_location | 31 | 31 | 1.000 | 0.540 | 0.527 | 0.577 |
| high_amount_unusual_hour | 26 | 26 | 1.000 | 0.586 | 0.551 | 0.627 |
| tampered_signature | 42 | 42 | 1.000 | 0.489 | 0.453 | 0.540 |
| forged_key | 15 | 12 | 0.800 | 0.481 | 0.435 | 0.522 |
