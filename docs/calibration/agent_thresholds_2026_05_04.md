...
**Date**: 2026-05-04T09:22:04.825441
**Sample size**: 200
**Random seed**: 42
**Optimal F1 operating threshold**: `0.50`
**Best F1**: `0.7976` (precision=0.9853, recall=0.6700)
...
| 0.40 | 0.521 | 1.000 | 0.685 | 100 | 92 | 8 | 0 |
| 0.45 | 0.576 | 0.760 | 0.655 | 76 | 56 | 44 | 24 |
| 0.50 | 0.985 | 0.670 | 0.798 | 67 | 1 | 99 | 33 |
...
|---|---|---|---|---|---|---|
| tampered_signature | 28 | 24 | 0.857 | 0.514 | 0.496 | 0.541 |
| high_amount_unusual_hour | 15 | 15 | 1.000 | 0.624 | 0.602 | 0.627 |
| no_signature_claimed | 25 | 0 | 0.000 | 0.439 | 0.420 | 0.455 |
| novel_merchant_location | 23 | 23 | 1.000 | 0.577 | 0.577 | 0.577 |
| forged_key | 9 | 5 | 0.556 | 0.502 | 0.484 | 0.514 |
