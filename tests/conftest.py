...
def sample_mouse_movements():
    ...
    for i in range(100):
        ...
        movements.append(
            {"x": x, "y": y, "timestamp": 1000 + i * 50, "event_type": "move"}
        )
...
def fraud_ring_network_data():
    ...
    for i in range(60):
        connections.append(
            {"entity_id": f"user{i}", "strength": 0.9, "transaction_count": 15}
        )
...
def edge_case_keystroke_data():
    ...
    return {
        ...
        "partial_timing": [{"press_time": 100}, {"release_time": 200}],
    }
...
def performance_test_data():
    ...
    return {
        ...
        "mouse_movements": [
            {"x": i % 1920, "y": i % 1080, "timestamp": i * 10} for i in range(5000)
        ],
    }
...
def comprehensive_analysis_result():
    ...
    return {
        ...
        "component_scores": {"transaction": 0.8, "behavioral": 0.7, "network": 0.6},
        "confidence": 0.85,
    }
