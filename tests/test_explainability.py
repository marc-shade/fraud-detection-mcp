...
class TestFraudExplainerUnit:
    ...
    def test_generate_summary_returns_string(self):
        ...
        explanation = {
            ...
            "prediction": 0.7,
            "risk_factors": [
                {"feature": "amount", "description": "High amount"}
            ],
            "protective_factors": [],
        }
...
class TestExplainDecisionWithTransactionData:
    ...
    def test_explain_with_transaction_data(self, sample_transaction_data):
        ...
        result = explain_decision_impl(analysis_result, transaction_data=sample_transaction_data)
        assert "feature_analysis" in result
        assert "explainability_method" in result
        assert result["explainability_method"] in ("SHAP", "Feature Importance", "Basic Analysis")
    ...
    def test_explain_with_preexisting_feature_explanation(self, sample_transaction_data):
...
class TestFeatureExplanationInTransaction:
    ...
    def test_feature_explanation_not_present_when_explainer_none(self, sample_transaction_data):
...
class TestModelStatusExplainability:
    ...
    def test_model_status_explainer_method(self):
        ...
        assert explainer_status["method"] in (
            "SHAP", "Feature Importance", "unavailable"
        )
...
class TestExplainabilityEndToEnd:
    ...
    def test_analyze_then_explain_flow(self, sample_transaction_data):
        ...
        from server import analyze_transaction_impl, explain_decision_impl, fraud_explainer
        if fraud_explainer is None:
            pytest.skip("FraudExplainer not available")
    ...
    @pytest.mark.integration
    def test_analyze_then_explain_without_transaction_data(self, sample_transaction_data):
    ...
    @pytest.mark.integration
    def test_batch_analyze_then_explain(self, sample_transaction_data, high_risk_transaction):
